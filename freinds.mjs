...
//   try {
//     const freindsId = await usersCollection.findOne(
//       { _id: userId },
//       { projection: { _id: 0, freinds: 1 } }
//     );
//     console.log(freindsId.freinds);
//     if (!freindsId.freinds) throw new Error("No friends.");
//     const freindsDeaitails = await usersCollection
//       .find(
//         { _id: { $in: freindsId.freinds } },
